...
from backend.modules.reports.router import router as reports_router # Add this line
...
api_router.include_router(reports_router, prefix="/reports", tags=["Reports"]) # Add this line
